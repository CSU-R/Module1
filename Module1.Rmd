...
- __Office Hours__: TBD on Microsoft Teams

- __Webpages__: [Canvas](https://canvas.colostate.edu), [this textbook](https://csu-r.github.io/Module1/)

- __Course Credits__: 1. Because this is a summer course, you'll be expected to digest the 

- __Textbook__: You're reading it right now. The textbook will be your primary learning resource. You'll be expected to read through the required sections, watch any relevant videos, and complete any reflections, progress checks, and assessments along the way.

- __Prerequisites__: None

- __Progress Checks__: As you work your way through the textbook, you'll encounter purple "Progress Check" boxes. You'll be provided a template RMarkdown Document to fill in as you complete the progress checks. About once per week, you'll compile the document and turn it in for grading via Canvas
...
- __Lectures__: Since we aren't having in-person lectures, we will hold short "Virtual Meetings" through MS Teams instead. These will be shorter than a traditional lecture (approximately 10-30 minutes), and the purpose will be to allow some interaction between everyone in the course and to allow the instructor to introduce any relevant topics.
...
sched <- data.frame(
  ...
  Reading = c("Ch1, Ch2", "Ch3", "Ch4", "Ch4", "Ch4", "Ch5", "Ch5", "Ch5", "Ch5", "Ch6", "Ch6", "Ch6"),
  Due= c("Progress Checks 1", "Quiz 1", "Assignment 1", "Progress Checks 2", "Quiz 1", "Assignment 2", "Progress Checks 3", "Quiz 1", "Assignment 3", "Progress Checks 4", "Quiz 4", "Assignment 4")
)
...
- Group Work: Students are welcome to discuss the course with each other, but all work you turn in must be your own. This means no sharing solutions to homework, progress checks, or quizzes. You _are_ welcome to seek help 
...
<!--chapter:end:src/06-CreatingRPrograms.Rmd-->
