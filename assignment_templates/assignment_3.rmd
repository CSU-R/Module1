...
Download the [data set](data_raw/top10s.csv) and save it in your data_raw folder.
Read the dataset into R to an object called `top`.

```{r}
top <- read.csv("data_raw/top10s.csv")
```
...
Make sure to set an appropriate title and axis titles.
Which genre tends to have more popular songs?
