...
1. Select `File > Save as` and save the file by adding your last name at the beginning with an underscore, example: `fout_progress_check_4.rmd`
...
1. Your completed assignment should contain all progress checks from section 5.5 through section 6.1
