...
```{block, type="video"}
[This Video](https://youtu.be/MhvipLohEfU) gives a basic introduction to R Markdown.
```
...
Download the [progress check 2 template](assignment_templates/progress_check_2.rmd) into your `data_raw` folder, and follow the instructions.
That document should include all progress reports from Section 4.1 through (and including) Section 4.3
