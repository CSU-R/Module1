...
One _very_ useful method that R provides is to use a logical array to index a vector.
As the following example will show, R will give only the elements which are 
