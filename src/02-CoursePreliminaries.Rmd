...
- __Instructor__: [Addison Adams](mailto:addison.adams@colostate.edu)

- __Office Hours__: Held via Zoom (link on Canvas), schedule on Canvas.
...
- __Assignments/What-to-turn-in__: This course will be graded on three types of assignments: Progress Checks, Homeworks, and Quizzes. There will be four of each. Most weeks, you will have one of these three types of assignments due. Due dates will be on Tuesdays at 11:59 pm (please see schedule below).

- __Progress Checks__: As you work your way through the textbook, you'll encounter purple "Progress Check" boxes. For the first Progress Check, you'll submit your responses directly to canvas. For Progress Checks 2-4, you'll fill in a R Markdown document and submit it to canvas. You'll be provided a template to fill in as you complete the progress checks. To turn in the document, you'll **knit** the document to HTML or PDF and upload to Canvas. (More details coming later in the book!). Progress checks will be graded on completion, organization, and correctness. Progress Checks must be turned in by 11:50pm (Mountain) on the day they are due. Half credit will be given for two-day window after the due date, after which no credit will be possible.

- __Homework__: There are four homeworks during the semester. You'll complete each homework using R. Homeworks must be turned in by 11:59pm (Mountain) on the day they are due. Half credit will be given for two-day window after the due date, after which no credit will be possible.

- __Quizzes__: There will be four 15 minute Canvas quizzes during the semester. Quizzes must be completed by 11:59pm (Mountain) on the day they are due. __There are NO late quizzes excepted after the due date has passed. If you cannot complete the quiz on the day it is due, you are expected to do it early__.

- __Exams__: There will be no exams in this course

- __Lectures__: Lectures will be held on Fridays. There will be _mini-lectures_, approximately 10-30 minutes. The mini-lectures will be based on previously read material, no new material will be presented. Students are expected to have read before the lecture. The reminder of the time will be _student-lead_. We will cover questions students may have or work on homework together.
...
- [Assignment 1](assignment_templates/assignment_1.rmd)
- [Assignment 2](assignment_templates/assignment_2.rmd)
- [Assignment 3](assignment_templates/assignment_3.rmd)
- [Assignment 4](assignment_templates/assignment_4.rmd)
