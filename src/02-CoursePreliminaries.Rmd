...
- __Office Hours__: Held via Zoom, meeting room provided in Canvas announcements and schedule provided on Canvas homepage.
...
- __Homework__: You'll complete assignments using R. Homeworks must be turned in by 11:59pm (Mountain) on the day they are due.

- __Exams__: There will be no exams in this course.

- __Quizzes__: There will be a 15 minute Canvas quizes. Quizzes must be completed by 11:59pm (Mountain) on the day they are due.

- __Discussion__: You are required to respond to one reflection prompted in the textbook within the discussion board on Canvas. You can choose which to respond to, but it must not already be assigned.  More importantly, the discussion boards should also be used to ask and answer questions regarding the material.
