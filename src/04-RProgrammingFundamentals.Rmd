...
Imagine having to write down this vector on a piece of paper, and the space it would take.
...
```{block, type="assessment"}
Download the [progress check 3 template](assignment_templates/progress_check_3.rmd) into your `scripts` folder, and follow the instructions.
