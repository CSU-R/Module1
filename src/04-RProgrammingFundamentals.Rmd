...
```{block, type="video"}
[This video](https://youtu.be/EShV_T2P7sw) discusses programming preliminaries.
```
...
```{block, type="video"}
[This video](https://youtu.be/juscNzIrmJQ) discusses numerics.
```
...
```{block, type="video"}
[This video](https://youtu.be/rNkEAPsipCk) discusses integers.
```
...
```{block, type="video"}
[This video](https://youtu.be/1JgmnulM_4g) discusses characters.
```
...
```{block, type="video"}
[This video](https://youtu.be/GH9AZcexokU) discusses logicals.
```
...
```{block, type="video"}
[This video](https://youtu.be/-BlN6_ZMpKE) gives an introduction to vectors.
```
...
```{block, type="video"}
[This video](https://youtu.be/NgmVhLpuM5k) continues the discussion of vectors.
```
...
```{block, type="video"}
[This video](https://youtu.be/iusiO1dRQdY) discusses coercion, sequences, and factors.
```
...
```{block, type="video"}
[This video](https://youtu.be/XKdZzHBRO9o) finishes the discussion of vectors.
```
...
```{block, type="video"}
[This video](https://youtu.be/hknL1EbrIB4) gives an introduction to Vectors.
```
...
```{block, type="video"}
[This video](https://youtu.be/-Y02JkqDlWU) discusses lists.
```
...
```{block, type="video"}
[This video](https://youtu.be/9BGRIC1js04) discusses lists of vectors.
```
...
```{block, type="video"}
[This video](https://youtu.be/VrgoEoMo9ZM) discusses lists of vectors.
```
