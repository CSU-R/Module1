...
sched <- data.frame(
  ...
  Due= c("Progress Check 1", "Quiz 1", "Assignment 1", "Progress Check 2", "Quiz 1", "Assignment 2", "Progress Check 3", "Quiz 1", "Assignment 3", "Progress Check 4", "Quiz 4", "Assignment 4")
)
