...
This course is presented as a [bookdown](bookdown.org) document, and is divided into chapters and sections
...
The faint left and right arrows at the bottom of each page allow you to step to the next/previous section.
...
In a browser, navigate to [rdrr.io/snippets](rdrr.io/snippets), where you'll see a box that looks like this:
